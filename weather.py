...
class Weather:
    ...
    def to_dict(self):
        return {
            ...
            'in_temperature': self.in_temperature,
            'out_temperature': self.out_temperature,
            'in_humidity': self.in_humidity,
            'out_humidity': self.out_humidity,
            'rain_rate': self.rain_rate,
            'ten_min_wind_speed': self.ten_min_wind_speed,
            'wind_direction': self.wind_direction,
            'wind_speed': self.wind_speed,
            'uv': self.uv,
            'solar_radiation': self.solar_radiation,
            'storm_rain': self.storm_rain,
            'start_date_storm': self.start_date_storm,
            'day_rain': self.day_rain,
            'month_rain': self.month_rain,
            'year_rain': self.year_rain,
            'day_et': self.day_et,
            'month_et': self.month_et,
            'year_et': self.year_et,
            'inside_alarm': self.inside_alarm,
            'rain_alarm': self.rain_alarm,
            'outside_alarm': self.outside_alarm,
            'transmitter_battery': self.transmitter_battery,
            'console_battery': self.console_battery,
            'forecast_icon': self.forecast_icon,
            'forecast_rule_number': self.forecast_rule_number,
            'time_of_sunrise': self.time_of_sunrise,
            'time_of_sunset': self.time_of_sunset
        }
